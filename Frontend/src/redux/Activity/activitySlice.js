...
export const fetchActivities = createAsyncThunk('activity/fetchActivities', async (groupId) => {
    ...
    try {
        const response = await axios.get(`http://localhost:5000/activity/${groupId}/activities`, { withCredentials: true });
...
export const addActivity = createAsyncThunk('activity/addActivity', async ({ groupId, action, details }, thunkAPI) => {
    ...
    try {
        const response = await axios.post(`http://localhost:5000/activity/${groupId}/activities`, { action, details }, { withCredentials: true });
